...
AI 開發的領域時，我們常會被各種名詞轟炸：TensorFlow, Keras, Scikit-learn, XGBoost, CMA-ES... 它們有些是「工具」，有些是「演算法」，有些是「數學概念」。
...
這才是最精彩的部分。 中，這些技術往往是**串聯**使用的，而不是互斥的。
...
- **任務**：它看的是「策略的績效」。它負責調整角色 A 和 角色 B 的參數。
